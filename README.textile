...
A Rails 5.0 example application to accompany the book "Learn Ruby on Rails":http://learn-rails.com/learn-ruby-on-rails.html.
...
h2. The Book: 'Learn Ruby on Rails'
...
h4. Latest Version, Book One: 3.0.0

Book One does not contain code from the application and does not change often. The most recent version of the book was released January 14, 2016.

h4. Latest Version, Book Two: 4.0.0

Book Two contains a tutorial application and changes more frequently. The most recent version of the book was written for Rails 5.0 and released October 31, 2016. Please make sure you have the newest version of the book (or the code examples may not work). The book version is shown on the title page. "Get the book":http://learn-rails.com/learn-ruby-on-rails.html if you need the new version.

h4. Application Version: 4.0.0

This example application (here on GitHub) is the same as the code in Book Two.
