...
h4. Current Version: 2.0.4

This example application (here on GitHub) is newer than the code in the book. For recent changes, see:
...
* updated Ruby from version 2.1.1 to 2.1.3
* updated Rails from version 4.1.1 to Rails 4.1.6
* specify 'foundation-rails 5.4.3.1' in the Gemfile (don't use foundation-rails 5.4.4.0) pending resolution of "issue #38":https://github.com/RailsApps/learn-rails/issues/38
