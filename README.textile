...
h4. Current Version: 1.b16 or 1.c16

This example application (here on GitHub) is more current than the code in the book. For recent changes, see:
...
To duplicate the example code from the book, choose "Zurb Foundation 4.0".
