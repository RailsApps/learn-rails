...
h4. Latest Book Version: 2.1.1

The most recent version of the book was written for Rails 4.1 and released October 22, 2014. Please make sure you have the newest version of the book (or the code examples may not work). The book version is shown on the title page. "Get the book":http://learn-rails.com/learn-ruby-on-rails.html if you need the new version.

h4. Application Version: 2.1.0
