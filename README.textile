...
h4. Latest Book Version: 2.0.2

The most recent version of the book was written for Rails 4.1.

h4. Application Version: 2.0.5

This example application (here on GitHub) is newer than the code in the book. In particular:

* updated Ruby from version 2.1.1 to 2.1.3
* updated Rails from version 4.1.1 to Rails 4.1.6

For other recent changes, see:
